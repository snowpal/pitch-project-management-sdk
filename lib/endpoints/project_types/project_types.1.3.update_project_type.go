...
func UpdateProjectType(jwtToken string, reqBody request.ProjectTypeReqBody, projectTypeId string) (response.ProjectType, error) {
	...
	route, err := helpers2.GetRoute(lib.RouteProjectTypesUpdateProjectType, projectTypeId)
	if err != nil {
		fmt.Println(err)
		return resProjectType, err
	}
